...
?>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>The Emergency Ambulance Hiring Portal is a web-based platform designed to ficiliate the quick and efficient booking of ambulances during medical emergencies. This initiative aims to streamline the process of requesting and dispatching ambulance services, Ensuring that help is readily available when need.</p>
        </div>
